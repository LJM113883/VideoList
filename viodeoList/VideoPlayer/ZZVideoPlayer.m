...
- (void)sliderValueChange:(ZZSlider *)slider {
...
- (UIView *)bottomBar {
    if (!_bottomBar) {
        ...
        [fullScreenBtn setImage:[UIImage imageNamed:@"player_unfullscreen"] forState:UIControlStateSelected];
        ...
        ZZSlider *slider = [[ZZSlider alloc] init];
        slider.value = 0.0f;
        ...
        self.slider = slider;
        __weak typeof(self) weakSelf = self;
        slider.valueChangeBlock = ^(ZZSlider *slider){
            [weakSelf sliderValueChange:slider];
        };
        slider.finishChangeBlock = ^(ZZSlider *slider){
            [weakSelf finishChange];
        };
        slider.draggingSliderBlock = ^(ZZSlider *slider){
            [weakSelf dragSlider];
        };
...
- (UIButton *)playOrPauseBtn {
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"player_play"] forState:UIControlStateNormal];
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"player_pouse"] forState:UIControlStateSelected];
